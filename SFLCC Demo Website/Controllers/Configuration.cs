...
//                var imagecollection = item.SelectNodes(item.XPath + "/td[1]/font/img");
...
//                var companyimagecollection = item.SelectNodes(item.XPath + "/td[4]/font/img");
...
//                            SessionEnd = DateTime.Parse(string.Format("02/07/2015 {0}", slotStart)).AddHours(1).AddMinutes(10)
//                        });
//                }
//            }
...
//            {
//                int slotcounter = 0;
//                foreach (var slot in context.SessionSlots.ToList())
//                {
...
//                var slotNumber = int.Parse(slot.XPath.Split('/').Last().Split(new char[] { '[', ']' }, StringSplitOptions.RemoveEmptyEntries).Last()) - 4;
